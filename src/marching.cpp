...
void Fluid2d<Ni, Nj, Nb>::march_ssprk3(const double& dt,
  ...
  for (int i = 0; i < Ni - 2 * Nb; ++i) {
    for (int j = 0; j < Nj - 2 * Nb; ++j) {
      ...
      calc_conserved(rho[Nb + i][Nb + j], u[Nb + i][Nb + j], v[Nb + i][Nb + j],
                     e[Nb + i][Nb + j], SA, arr_Q0[i][j]);
    }
  }
  ...
  for (int i = 0; i < Ni - 2 * Nb; ++i) {
    for (int j = 0; j < Nj - 2 * Nb; ++j) {
      ...
      SA = 0.25 * (S[Nb + i - 1][Nb + j - 1] + S[Nb + i][Nb + j - 1] +
                   S[Nb + i - 1][Nb + j] + S[Nb + i][Nb + j]);
      calc_basic(arr_Q1[i][j], SA, rho[Nb + i][Nb + j], u[Nb + i][Nb + j],
  ...
  for (int i = 0; i < Ni - 2 * Nb; ++i) {
    for (int j = 0; j < Nj - 2 * Nb; ++j) {
      ...
      SA = 0.25 * (S[Nb + i - 1][Nb + j - 1] + S[Nb + i][Nb + j - 1] +
                   S[Nb + i - 1][Nb + j] + S[Nb + i][Nb + j]);
      calc_basic(arr_Q2[i][j], SA, rho[Nb + i][Nb + j], u[Nb + i][Nb + j],
                 v[Nb + i][Nb + j], e[Nb + i][Nb + j]);
    }
  }
  // reflecting boundary condition
  ...
  for (int i = 0; i < Ni - 2 * Nb; ++i) {
    for (int j = 0; j < Nj - 2 * Nb; ++j) {
      ...
      SA = 0.25 * (S[Nb + i - 1][Nb + j - 1] + S[Nb + i][Nb + j - 1] +
                   S[Nb + i - 1][Nb + j] + S[Nb + i][Nb + j]);
      calc_basic(arr_Q0[i][j], SA, rho[Nb + i][Nb + j], u[Nb + i][Nb + j],
                 v[Nb + i][Nb + j], e[Nb + i][Nb + j]);
    }
  }
  // reflecting boundary condition
...
double Fluid2d<Ni, Nj, Nb>::calc_cfl(const double CFL_coeff) const {
  ...
  for (int i = 0; i < Ni - 2 * Nb; ++i) {
    for (int j = 0; j < Nj - 2 * Nb; ++j) {
      tmp = dx[i][j] / (calc_cs(rho[i + Nb][j + Nb], u[i + Nb][j + Nb],
...
void Fluid2d<Ni, Nj, Nb>::rhs(const double (&rho)[Ni][Nj],
                              ...
                              const double (&v)[Ni][Nj],
                              const double (&e)[Ni][Nj],
    ...
    for (int j = 0; j < Nj - 2 * Nb; ++j) {
      ...
      if (reconstruction == "MUSCL_minmod_basic") {
        reconstruction_basic_muscl3(
            ...
            rho[Nb + i][Nb + j], rho[Nb + i + 1][Nb + j], u[Nb + i - 2][Nb + j],
            u[Nb + i - 1][Nb + j], u[Nb + i][Nb + j], u[Nb + i + 1][Nb + j],
            v[Nb + i - 2][Nb + j], v[Nb + i - 1][Nb + j], v[Nb + i][Nb + j],
            v[Nb + i + 1][Nb + j], e[Nb + i - 2][Nb + j], e[Nb + i - 1][Nb + j],
            e[Nb + i][Nb + j], e[Nb + i + 1][Nb + j], rhoL, uL, vL, eL, rhoR,
            uR, vR, eR);
        ...
        reconstruction_basic_mp5(
            ...
            u[Nb + i - 3][Nb + j], u[Nb + i - 2][Nb + j], u[Nb + i - 1][Nb + j],
            u[Nb + i][Nb + j], u[Nb + i + 1][Nb + j], u[Nb + i + 2][Nb + j],
            v[Nb + i - 3][Nb + j], v[Nb + i - 2][Nb + j], v[Nb + i - 1][Nb + j],
            v[Nb + i][Nb + j], v[Nb + i + 1][Nb + j], v[Nb + i + 2][Nb + j],
            e[Nb + i - 3][Nb + j], e[Nb + i - 2][Nb + j], e[Nb + i - 1][Nb + j],
            e[Nb + i][Nb + j], e[Nb + i + 1][Nb + j], e[Nb + i + 2][Nb + j],
            rhoL, uL, vL, eL, rhoR, uR, vR, eR);
      } else {
        std::cout << "ERROR Fluid2d::rhs > Reconstruction scheme cannnot be "
                     "specified.";
        exit(EXIT_FAILURE);
      }
      ...
      if (flux_scheme == "Roe_FDS") {
        roe_fds(rhoL, uL, vL, eL, rhoR, uR, vR, eR, ixSA, iySA, SA,
                arr_Fi[i][j]);
      } else {
    ...
    for (int j = 0; j < Nj - 2 * Nb + 1; ++j) {
      ...
      if (reconstruction == "MUSCL_minmod_basic") {
        reconstruction_basic_muscl3(
            ...
            rho[Nb + i][Nb + j], rho[Nb + i][Nb + j + 1], u[Nb + i][Nb + j - 2],
            u[Nb + i][Nb + j - 1], u[Nb + i][Nb + j], u[Nb + i][Nb + j + 1],
            v[Nb + i][Nb + j - 2], v[Nb + i][Nb + j - 1], v[Nb + i][Nb + j],
            v[Nb + i][Nb + j + 1], e[Nb + i][Nb + j - 2], e[Nb + i][Nb + j - 1],
            e[Nb + i][Nb + j], e[Nb + i][Nb + j + 1], rhoL, uL, vL, eL, rhoR,
            uR, vR, eR);
      } else if (reconstruction == "MP5_basic") {
        reconstruction_basic_mp5(
            ...
            u[Nb + i][Nb + j - 3], u[Nb + i][Nb + j - 2], u[Nb + i][Nb + j - 1],
            u[Nb + i][Nb + j], u[Nb + i][Nb + j + 1], u[Nb + i][Nb + j + 2],
            v[Nb + i][Nb + j - 3], v[Nb + i][Nb + j - 2], v[Nb + i][Nb + j - 1],
            v[Nb + i][Nb + j], v[Nb + i][Nb + j + 1], v[Nb + i][Nb + j + 2],
            e[Nb + i][Nb + j - 3], e[Nb + i][Nb + j - 2], e[Nb + i][Nb + j - 1],
            e[Nb + i][Nb + j], e[Nb + i][Nb + j + 1], e[Nb + i][Nb + j + 2],
            rhoL, uL, vL, eL, rhoR, uR, vR, eR);
      } else {
        std::cout << "ERROR Fluid2d::rhs > Reconstruction scheme cannnot be "
                     "specified.";
      ...
      if (flux_scheme == "Roe_FDS") {
        roe_fds(rhoL, uL, vL, eL, rhoR, uR, vR, eR, jxSA, jySA, SA,
                arr_Fj[i][j]);
      } else {
        std::cout << "ERROR Fluid2d::rhs > Flux scheme cannnot be specified.";
        exit(EXIT_FAILURE);
